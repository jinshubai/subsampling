...
class selection_rank_fun: public function
{
	...
	protected:
		...
		void get_alpha(double *alpha, double gs, double sTs, double *s, long int *num_data);//added
...
void selection_rank_fun::get_alpha(double *alpha, double gs, double sTs, double *s, long int *num_data)
{
	int i;
	int l = prob->l;
